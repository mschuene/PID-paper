function [x,fval,x_orig,gb,igb,V,inner,arank,unique] = Min_MI_X_YZ_binary_T(p,options,use_hess,only_inner,calc_extreme_points)
   ...
   if nargin < 5
    ...
    # optionally use Matt J (2023). Analyze N-dimensional Convex Polyhedra
    # (https://www.mathworks.com/matlabcentral/fileexchange/30892-analyze-n-dimensional-convex-polyhedra),
    # MATLAB Central File Exchange. Retrieved June 6, 2023.
    # to calculate extremal points of optimization domain
